    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed inset-0 z-[999] flex flex-col items-center justify-center bg-[#F7EFE6]"
          style={{
            backgroundImage: 'radial-gradient(circle at center, rgba(200, 155, 91, 0.08) 0%, transparent 60%)'
          }}
        >
          <div className="relative flex flex-col items-center gap-6">
            ...
            <div className="relative w-28 h-28 flex items-center justify-center">
              <motion.div
                ...
                className="absolute inset-0 rounded-full border-2 border-dashed border-[#C89B5B]"
              />
              <motion.div
                animate={{ rotate: -360 }}
            ...
            <div className="text-center flex flex-col gap-2">
              <motion.h1 
                ...
                className="font-marcellus text-3xl font-extrabold text-[#2B1A12] uppercase tracking-[2px]"
              >
                LORAN STUDIO
              </motion.h1>
              <motion.p 
                ...
                className="text-[#7A4A2A] font-bold text-sm tracking-wide"
              >
            ...
            {/* Progress line */}
            <div className="w-40 h-[2px] bg-[#2B1A12]/10 rounded-full overflow-hidden mt-4">
              <motion.div 
                initial={{ width: 0 }}
                animate={{ width: '100%' }}
                transition={{ duration: 1.2, ease: "easeInOut" }}
                className="h-full bg-gradient-to-r from-transparent via-[#C89B5B] to-[#7A4A2A]"
              />
            </div>
          </div>
        </motion.div>
